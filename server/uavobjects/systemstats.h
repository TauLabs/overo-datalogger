...
#define SystemStatsCreateInstance() UAVObjCreateInstance(SystemStatsHandle(),&SystemStatsSetDefaults)
...
#define SystemStatsReadOnly() UAVObjReadOnly(SystemStatsHandle())
