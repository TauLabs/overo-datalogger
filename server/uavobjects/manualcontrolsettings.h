...
// Object constants
#define MANUALCONTROLSETTINGS_OBJID 0x6C188320
...
typedef enum { MANUALCONTROLSETTINGS_FAILSAFEBEHAVIOR_NONE=0, MANUALCONTROLSETTINGS_FAILSAFEBEHAVIOR_RTH=1 } ManualControlSettingsFailsafeBehaviorOptions;
