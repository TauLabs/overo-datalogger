...
typedef enum { ACTUATORSETTINGS_CHANNELTYPE_PWM=0, ACTUATORSETTINGS_CHANNELTYPE_MK=1, ACTUATORSETTINGS_CHANNELTYPE_ASTEC4=2, ACTUATORSETTINGS_CHANNELTYPE_PWMALARMBUZZER=3, ACTUATORSETTINGS_CHANNELTYPE_ARMINGLED=4, ACTUATORSETTINGS_CHANNELTYPE_INFOLED=5 }  __attribute__((packed)) ActuatorSettingsChannelTypeOptions;
