...
static inline int32_t VtolPathFollowerStatusConnectQueue(xQueueHandle queue) { return UAVObjConnectQueue(VtolPathFollowerStatusHandle(), queue, EV_MASK_ALL_UPDATES); }
