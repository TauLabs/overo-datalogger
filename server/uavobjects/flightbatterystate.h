...
#define FlightBatteryStateCreateInstance() UAVObjCreateInstance(FlightBatteryStateHandle(),&FlightBatteryStateSetDefaults)
...
#define FlightBatteryStateReadOnly() UAVObjReadOnly(FlightBatteryStateHandle())
