 ...
 * @param[out] dataOut 
 */
#define VtolPathFollowerSettingsGet(dataOut) UAVObjGetData(VtolPathFollowerSettingsHandle(), dataOut)
#define VtolPathFollowerSettingsSet(dataIn) UAVObjSetData(VtolPathFollowerSettingsHandle(), dataIn)
#define VtolPathFollowerSettingsInstGet(instId, dataOut) UAVObjGetInstanceData(VtolPathFollowerSettingsHandle(), instId, dataOut)
#define VtolPathFollowerSettingsInstSet(instId, dataIn) UAVObjSetInstanceData(VtolPathFollowerSettingsHandle(), instId, dataIn)
#define VtolPathFollowerSettingsConnectQueue(queue) UAVObjConnectQueue(VtolPathFollowerSettingsHandle(), queue, EV_MASK_ALL_UPDATES)
#define VtolPathFollowerSettingsConnectCallback(cb) UAVObjConnectCallback(VtolPathFollowerSettingsHandle(), cb, EV_MASK_ALL_UPDATES)
#define VtolPathFollowerSettingsCreateInstance() UAVObjCreateInstance(VtolPathFollowerSettingsHandle(),&VtolPathFollowerSettingsSetDefaults)
#define VtolPathFollowerSettingsRequestUpdate() UAVObjRequestUpdate(VtolPathFollowerSettingsHandle())
#define VtolPathFollowerSettingsRequestInstUpdate(instId) UAVObjRequestInstanceUpdate(VtolPathFollowerSettingsHandle(), instId)
#define VtolPathFollowerSettingsUpdated() UAVObjUpdated(VtolPathFollowerSettingsHandle())
#define VtolPathFollowerSettingsInstUpdated(instId) UAVObjUpdated(VtolPathFollowerSettingsHandle(), instId)
#define VtolPathFollowerSettingsGetMetadata(dataOut) UAVObjGetMetadata(VtolPathFollowerSettingsHandle(), dataOut)
#define VtolPathFollowerSettingsSetMetadata(dataIn) UAVObjSetMetadata(VtolPathFollowerSettingsHandle(), dataIn)
#define VtolPathFollowerSettingsReadOnly() UAVObjReadOnly(VtolPathFollowerSettingsHandle())
...
} __attribute__((packed)) VtolPathFollowerSettingsData;
