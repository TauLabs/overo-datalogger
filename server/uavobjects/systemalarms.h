...
// Object constants
#define SYSTEMALARMS_OBJID 0x737ADCF2
...
#define SystemAlarmsCreateInstance() UAVObjCreateInstance(SystemAlarmsHandle(),&SystemAlarmsSetDefaults)
...
#define SystemAlarmsReadOnly() UAVObjReadOnly(SystemAlarmsHandle())
...
typedef enum { SYSTEMALARMS_ALARM_OUTOFMEMORY=0, SYSTEMALARMS_ALARM_STACKOVERFLOW=1, SYSTEMALARMS_ALARM_CPUOVERLOAD=2, SYSTEMALARMS_ALARM_EVENTSYSTEM=3, SYSTEMALARMS_ALARM_TELEMETRY=4, SYSTEMALARMS_ALARM_MANUALCONTROL=5, SYSTEMALARMS_ALARM_ACTUATOR=6, SYSTEMALARMS_ALARM_ATTITUDE=7, SYSTEMALARMS_ALARM_SENSORS=8, SYSTEMALARMS_ALARM_STABILIZATION=9, SYSTEMALARMS_ALARM_GUIDANCE=10, SYSTEMALARMS_ALARM_BATTERY=11, SYSTEMALARMS_ALARM_FLIGHTTIME=12, SYSTEMALARMS_ALARM_I2C=13, SYSTEMALARMS_ALARM_GPS=14, SYSTEMALARMS_ALARM_BOOTFAULT=15, SYSTEMALARMS_ALARM_POWER=16 } SystemAlarmsAlarmElem;
/* Number of elements for field Alarm */
#define SYSTEMALARMS_ALARM_NUMELEM 17
