...
// Object constants
#define TASKINFO_OBJID 0x9B7BD752
#define TASKINFO_ISSINGLEINST 1
#define TASKINFO_ISSETTINGS 0
#define TASKINFO_NUMBYTES 136
...
// Object data
typedef struct {
    uint16_t StackRemaining[34];
    uint8_t Running[34];
    uint8_t RunningTime[34];
