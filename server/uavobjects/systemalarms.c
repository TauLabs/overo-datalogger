...
{
	UAVObjSetDataField(SystemAlarmsHandle(), (void*)NewAlarm, offsetof( SystemAlarmsData, Alarm), 19*sizeof(uint8_t));
}
void SystemAlarmsAlarmGet( uint8_t *NewAlarm )
{
	UAVObjGetDataField(SystemAlarmsHandle(), (void*)NewAlarm, offsetof( SystemAlarmsData, Alarm), 19*sizeof(uint8_t));
}
