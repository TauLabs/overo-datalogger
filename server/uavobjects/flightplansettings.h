...
#define FlightPlanSettingsCreateInstance() UAVObjCreateInstance(FlightPlanSettingsHandle(),&FlightPlanSettingsSetDefaults)
...
#define FlightPlanSettingsReadOnly() UAVObjReadOnly(FlightPlanSettingsHandle())
