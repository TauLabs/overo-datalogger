...
void SystemStatsHeapRemainingGet( uint16_t *NewHeapRemaining )
{
	UAVObjGetDataField(SystemStatsHandle(), (void*)NewHeapRemaining, offsetof( SystemStatsData, HeapRemaining), sizeof(uint16_t));
}
