...
#define VelocityActualCreateInstance() UAVObjCreateInstance(VelocityActualHandle(),&VelocityActualSetDefaults)
...
#define VelocityActualReadOnly() UAVObjReadOnly(VelocityActualHandle())
