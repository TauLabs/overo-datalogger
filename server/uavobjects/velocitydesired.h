...
#define VelocityDesiredCreateInstance() UAVObjCreateInstance(VelocityDesiredHandle(),&VelocityDesiredSetDefaults)
...
#define VelocityDesiredReadOnly() UAVObjReadOnly(VelocityDesiredHandle())
