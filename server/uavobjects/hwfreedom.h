...
// Object constants
#define HWFREEDOM_OBJID 0x14111DF0
...
typedef enum { HWFREEDOM_MAINPORT_DISABLED=0, HWFREEDOM_MAINPORT_TELEMETRY=1, HWFREEDOM_MAINPORT_GPS=2, HWFREEDOM_MAINPORT_DSM2=3, HWFREEDOM_MAINPORT_DSMX10BIT=4, HWFREEDOM_MAINPORT_DSMX11BIT=5, HWFREEDOM_MAINPORT_DEBUGCONSOLE=6, HWFREEDOM_MAINPORT_COMBRIDGE=7, HWFREEDOM_MAINPORT_MAVLINKTX=8, HWFREEDOM_MAINPORT_MAVLINKTX_GPS_RX=9, HWFREEDOM_MAINPORT_HOTTSUMD=10, HWFREEDOM_MAINPORT_HOTTSUMH=11, HWFREEDOM_MAINPORT_HOTTTELEMETRY=12, HWFREEDOM_MAINPORT_FRSKYSENSORHUB=13, HWFREEDOM_MAINPORT_LIGHTTELEMETRYTX=14, HWFREEDOM_MAINPORT_PICOC=15, HWFREEDOM_MAINPORT_FRSKYSPORTTELEMETRY=16 }  __attribute__((packed)) HwFreedomMainPortOptions;
// Field FlexiPort information
/* Enumeration options for field FlexiPort */
typedef enum { HWFREEDOM_FLEXIPORT_DISABLED=0, HWFREEDOM_FLEXIPORT_TELEMETRY=1, HWFREEDOM_FLEXIPORT_GPS=2, HWFREEDOM_FLEXIPORT_I2C=3, HWFREEDOM_FLEXIPORT_DSM2=4, HWFREEDOM_FLEXIPORT_DSMX10BIT=5, HWFREEDOM_FLEXIPORT_DSMX11BIT=6, HWFREEDOM_FLEXIPORT_DEBUGCONSOLE=7, HWFREEDOM_FLEXIPORT_COMBRIDGE=8, HWFREEDOM_FLEXIPORT_MAVLINKTX=9, HWFREEDOM_FLEXIPORT_MAVLINKTX_GPS_RX=10, HWFREEDOM_FLEXIPORT_HOTTSUMD=11, HWFREEDOM_FLEXIPORT_HOTTSUMH=12, HWFREEDOM_FLEXIPORT_HOTTTELEMETRY=13, HWFREEDOM_FLEXIPORT_FRSKYSENSORHUB=14, HWFREEDOM_FLEXIPORT_LIGHTTELEMETRYTX=15, HWFREEDOM_FLEXIPORT_PICOC=16, HWFREEDOM_FLEXIPORT_FRSKYSPORTTELEMETRY=17 }  __attribute__((packed)) HwFreedomFlexiPortOptions;
// Field RcvrPort information
/* Enumeration options for field RcvrPort */
typedef enum { HWFREEDOM_RCVRPORT_DISABLED=0, HWFREEDOM_RCVRPORT_PPM=1, HWFREEDOM_RCVRPORT_DSM2=2, HWFREEDOM_RCVRPORT_DSMX10BIT=3, HWFREEDOM_RCVRPORT_DSMX11BIT=4, HWFREEDOM_RCVRPORT_SBUS=5, HWFREEDOM_RCVRPORT_HOTTSUMD=6, HWFREEDOM_RCVRPORT_HOTTSUMH=7 }  __attribute__((packed)) HwFreedomRcvrPortOptions;
// Field RadioPort information
/* Enumeration options for field RadioPort */
typedef enum { HWFREEDOM_RADIOPORT_DISABLED=0, HWFREEDOM_RADIOPORT_TELEMETRY=1 }  __attribute__((packed)) HwFreedomRadioPortOptions;
// Field USB_HIDPort information
/* Enumeration options for field USB_HIDPort */
typedef enum { HWFREEDOM_USB_HIDPORT_USBTELEMETRY=0, HWFREEDOM_USB_HIDPORT_RCTRANSMITTER=1, HWFREEDOM_USB_HIDPORT_DISABLED=2 }  __attribute__((packed)) HwFreedomUSB_HIDPortOptions;
// Field USB_VCPPort information
/* Enumeration options for field USB_VCPPort */
typedef enum { HWFREEDOM_USB_VCPPORT_USBTELEMETRY=0, HWFREEDOM_USB_VCPPORT_COMBRIDGE=1, HWFREEDOM_USB_VCPPORT_DEBUGCONSOLE=2, HWFREEDOM_USB_VCPPORT_PICOC=3, HWFREEDOM_USB_VCPPORT_DISABLED=4 }  __attribute__((packed)) HwFreedomUSB_VCPPortOptions;
