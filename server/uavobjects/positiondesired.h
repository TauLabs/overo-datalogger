...
#define PositionDesiredCreateInstance() UAVObjCreateInstance(PositionDesiredHandle(),&PositionDesiredSetDefaults)
...
#define PositionDesiredReadOnly() UAVObjReadOnly(PositionDesiredHandle())
...
// set/Get functions
extern void PositionDesiredNorthSet( float *NewNorth );
extern void PositionDesiredNorthGet( float *NewNorth );
extern void PositionDesiredEastSet( float *NewEast );
extern void PositionDesiredEastGet( float *NewEast );
extern void PositionDesiredDownSet( float *NewDown );
extern void PositionDesiredDownGet( float *NewDown );
