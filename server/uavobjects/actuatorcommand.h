...
#define ActuatorCommandCreateInstance() UAVObjCreateInstance(ActuatorCommandHandle(),&ActuatorCommandSetDefaults)
...
#define ActuatorCommandReadOnly() UAVObjReadOnly(ActuatorCommandHandle())
