...
#define BaroAltitudeCreateInstance() UAVObjCreateInstance(BaroAltitudeHandle(),&BaroAltitudeSetDefaults)
...
#define BaroAltitudeReadOnly() UAVObjReadOnly(BaroAltitudeHandle())
