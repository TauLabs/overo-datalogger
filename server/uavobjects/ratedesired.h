...
#define RateDesiredCreateInstance() UAVObjCreateInstance(RateDesiredHandle(),&RateDesiredSetDefaults)
...
#define RateDesiredReadOnly() UAVObjReadOnly(RateDesiredHandle())
