...
static inline int32_t OveroSyncStatsConnectQueue(struct pios_queue *queue) { return UAVObjConnectQueue(OveroSyncStatsHandle(), queue, EV_MASK_ALL_UPDATES); }
...
#define OVEROSYNCSTATS_CONNECTED_GLOBAL_MAXOPTVAL 1
/* Max value of any option in field Connected */
#define OVEROSYNCSTATS_CONNECTED_MAXOPTVAL 1
/* Ensure field Connected contains valid data */
static inline bool OveroSyncStatsConnectedIsValid( uint8_t CurrentConnected ) { return CurrentConnected < OVEROSYNCSTATS_CONNECTED_MAXOPTVAL; }
