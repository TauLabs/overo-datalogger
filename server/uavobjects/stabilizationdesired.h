...
// Object constants
#define STABILIZATIONDESIRED_OBJID 0xFB2AB214
...
static inline int32_t StabilizationDesiredConnectQueue(struct pios_queue *queue) { return UAVObjConnectQueue(StabilizationDesiredHandle(), queue, EV_MASK_ALL_UPDATES); }
...
typedef enum { STABILIZATIONDESIRED_STABILIZATIONMODE_NONE=0, STABILIZATIONDESIRED_STABILIZATIONMODE_RATE=1, STABILIZATIONDESIRED_STABILIZATIONMODE_ATTITUDE=2, STABILIZATIONDESIRED_STABILIZATIONMODE_AXISLOCK=3, STABILIZATIONDESIRED_STABILIZATIONMODE_WEAKLEVELING=4, STABILIZATIONDESIRED_STABILIZATIONMODE_VIRTUALBAR=5, STABILIZATIONDESIRED_STABILIZATIONMODE_HORIZON=6, STABILIZATIONDESIRED_STABILIZATIONMODE_MWRATE=7, STABILIZATIONDESIRED_STABILIZATIONMODE_SYSTEMIDENT=8, STABILIZATIONDESIRED_STABILIZATIONMODE_POI=9, STABILIZATIONDESIRED_STABILIZATIONMODE_COORDINATEDFLIGHT=10, STABILIZATIONDESIRED_STABILIZATIONMODE_ACROPLUS=11, STABILIZATIONDESIRED_STABILIZATIONMODE_LQG=12 }  __attribute__((packed)) StabilizationDesiredStabilizationModeOptions;
/* Max value of any option in topmost parent StabilizationMode of field StabilizationMode */
#define STABILIZATIONDESIRED_STABILIZATIONMODE_GLOBAL_MAXOPTVAL 12
/* Max value of any option in field StabilizationMode */
#define STABILIZATIONDESIRED_STABILIZATIONMODE_MAXOPTVAL 12
/* Ensure field StabilizationMode contains valid data */
static inline bool StabilizationDesiredStabilizationModeIsValid( uint8_t CurrentStabilizationMode ) { return CurrentStabilizationMode < STABILIZATIONDESIRED_STABILIZATIONMODE_MAXOPTVAL; }
