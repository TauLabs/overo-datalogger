...
#define AttitudeActualCreateInstance() UAVObjCreateInstance(AttitudeActualHandle(),&AttitudeActualSetDefaults)
...
#define AttitudeActualReadOnly() UAVObjReadOnly(AttitudeActualHandle())
