...
// Object constants
#define STATEESTIMATION_OBJID 0x9E007432
...
typedef enum { STATEESTIMATION_ATTITUDEFILTER_COMPLEMENTARY=0, STATEESTIMATION_ATTITUDEFILTER_INSINDOOR=1, STATEESTIMATION_ATTITUDEFILTER_INSOUTDOOR=2 } StateEstimationAttitudeFilterOptions;
// Field NavigationFilter information
/* Enumeration options for field NavigationFilter */
typedef enum { STATEESTIMATION_NAVIGATIONFILTER_RAW=0, STATEESTIMATION_NAVIGATIONFILTER_INS=1 } StateEstimationNavigationFilterOptions;
