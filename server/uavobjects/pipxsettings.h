...
typedef enum { PIPXSETTINGS_TELEMETRYCONFIG_DISABLED=0, PIPXSETTINGS_TELEMETRYCONFIG_SERIAL=1, PIPXSETTINGS_TELEMETRYCONFIG_UAVTALK=2, PIPXSETTINGS_TELEMETRYCONFIG_GCS=3, PIPXSETTINGS_TELEMETRYCONFIG_DEBUG=4 } PipXSettingsTelemetryConfigOptions;
...
typedef enum { PIPXSETTINGS_FLEXICONFIG_DISABLED=0, PIPXSETTINGS_FLEXICONFIG_SERIAL=1, PIPXSETTINGS_FLEXICONFIG_UAVTALK=2, PIPXSETTINGS_FLEXICONFIG_GCS=3, PIPXSETTINGS_FLEXICONFIG_PPM_IN=4, PIPXSETTINGS_FLEXICONFIG_PPM_OUT=5, PIPXSETTINGS_FLEXICONFIG_RSSI=6, PIPXSETTINGS_FLEXICONFIG_DEBUG=7 } PipXSettingsFlexiConfigOptions;
