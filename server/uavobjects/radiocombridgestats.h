...
static inline int32_t RadioComBridgeStatsConnectQueue(struct pios_queue *queue) { return UAVObjConnectQueue(RadioComBridgeStatsHandle(), queue, EV_MASK_ALL_UPDATES); }
