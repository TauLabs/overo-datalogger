...
{
	UAVObjSetDataField(TaskInfoHandle(), (void*)NewStackRemaining, offsetof( TaskInfoData, StackRemaining), 37*sizeof(uint16_t));
}
void TaskInfoStackRemainingGet( uint16_t *NewStackRemaining )
{
	UAVObjGetDataField(TaskInfoHandle(), (void*)NewStackRemaining, offsetof( TaskInfoData, StackRemaining), 37*sizeof(uint16_t));
}
void TaskInfoRunningSet( uint8_t *NewRunning )
{
	UAVObjSetDataField(TaskInfoHandle(), (void*)NewRunning, offsetof( TaskInfoData, Running), 37*sizeof(uint8_t));
}
void TaskInfoRunningGet( uint8_t *NewRunning )
{
	UAVObjGetDataField(TaskInfoHandle(), (void*)NewRunning, offsetof( TaskInfoData, Running), 37*sizeof(uint8_t));
}
void TaskInfoRunningTimeSet( uint8_t *NewRunningTime )
{
	UAVObjSetDataField(TaskInfoHandle(), (void*)NewRunningTime, offsetof( TaskInfoData, RunningTime), 37*sizeof(uint8_t));
}
void TaskInfoRunningTimeGet( uint8_t *NewRunningTime )
{
	UAVObjGetDataField(TaskInfoHandle(), (void*)NewRunningTime, offsetof( TaskInfoData, RunningTime), 37*sizeof(uint8_t));
}
