...
#define GPSPositionCreateInstance() UAVObjCreateInstance(GPSPositionHandle(),&GPSPositionSetDefaults)
...
#define GPSPositionReadOnly() UAVObjReadOnly(GPSPositionHandle())
