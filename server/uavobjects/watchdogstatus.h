...
#define WatchdogStatusCreateInstance() UAVObjCreateInstance(WatchdogStatusHandle(),&WatchdogStatusSetDefaults)
...
#define WatchdogStatusReadOnly() UAVObjReadOnly(WatchdogStatusHandle())
