...
// Object constants
#define HWSPARKY_OBJID 0x904CC778
...
typedef enum { HWSPARKY_FLEXIPORT_DISABLED=0, HWSPARKY_FLEXIPORT_TELEMETRY=1, HWSPARKY_FLEXIPORT_DEBUGCONSOLE=2, HWSPARKY_FLEXIPORT_COMBRIDGE=3, HWSPARKY_FLEXIPORT_GPS=4, HWSPARKY_FLEXIPORT_SBUS=5, HWSPARKY_FLEXIPORT_DSM2=6, HWSPARKY_FLEXIPORT_DSMX10BIT=7, HWSPARKY_FLEXIPORT_DSMX11BIT=8, HWSPARKY_FLEXIPORT_MAVLINKTX=9, HWSPARKY_FLEXIPORT_MAVLINKTX_GPS_RX=10 }  __attribute__((packed)) HwSparkyFlexiPortOptions;
// Field MainPort information
/* Enumeration options for field MainPort */
typedef enum { HWSPARKY_MAINPORT_DISABLED=0, HWSPARKY_MAINPORT_TELEMETRY=1, HWSPARKY_MAINPORT_DEBUGCONSOLE=2, HWSPARKY_MAINPORT_COMBRIDGE=3, HWSPARKY_MAINPORT_GPS=4, HWSPARKY_MAINPORT_SBUS=5, HWSPARKY_MAINPORT_DSM2=6, HWSPARKY_MAINPORT_DSMX10BIT=7, HWSPARKY_MAINPORT_DSMX11BIT=8, HWSPARKY_MAINPORT_MAVLINKTX=9, HWSPARKY_MAINPORT_MAVLINKTX_GPS_RX=10 }  __attribute__((packed)) HwSparkyMainPortOptions;
