...
static inline int32_t WindVelocityActualConnectQueue(struct pios_queue *queue) { return UAVObjConnectQueue(WindVelocityActualHandle(), queue, EV_MASK_ALL_UPDATES); }
