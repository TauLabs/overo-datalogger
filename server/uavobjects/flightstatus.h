...
// Object constants
#define FLIGHTSTATUS_OBJID 0x743DB13C
...
typedef enum { FLIGHTSTATUS_FLIGHTMODE_MANUAL=0, FLIGHTSTATUS_FLIGHTMODE_STABILIZED1=1, FLIGHTSTATUS_FLIGHTMODE_STABILIZED2=2, FLIGHTSTATUS_FLIGHTMODE_STABILIZED3=3, FLIGHTSTATUS_FLIGHTMODE_VELOCITYCONTROL=4, FLIGHTSTATUS_FLIGHTMODE_POSITIONHOLD=5 } FlightStatusFlightModeOptions;
