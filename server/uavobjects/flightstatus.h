...
// Object constants
#define FLIGHTSTATUS_OBJID 0xCD8C7996
...
static inline int32_t FlightStatusConnectQueue(struct pios_queue *queue) { return UAVObjConnectQueue(FlightStatusHandle(), queue, EV_MASK_ALL_UPDATES); }
