...
// Object constants
#define FLIGHTSTATUS_OBJID 0x884FEF66
...
typedef enum { FLIGHTSTATUS_FLIGHTMODE_MANUAL=0, FLIGHTSTATUS_FLIGHTMODE_STABILIZED1=1, FLIGHTSTATUS_FLIGHTMODE_STABILIZED2=2, FLIGHTSTATUS_FLIGHTMODE_STABILIZED3=3, FLIGHTSTATUS_FLIGHTMODE_ALTITUDEHOLD=4, FLIGHTSTATUS_FLIGHTMODE_VELOCITYCONTROL=5, FLIGHTSTATUS_FLIGHTMODE_POSITIONHOLD=6, FLIGHTSTATUS_FLIGHTMODE_PATHPLANNER=7, FLIGHTSTATUS_FLIGHTMODE_RTH=8 } FlightStatusFlightModeOptions;
