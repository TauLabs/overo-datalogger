...
// Object constants
#define ATTITUDERAW_OBJID 0xDB722974
...
#define AttitudeRawCreateInstance() UAVObjCreateInstance(AttitudeRawHandle(),&AttitudeRawSetDefaults)
...
#define AttitudeRawReadOnly() UAVObjReadOnly(AttitudeRawHandle())
...
// set/Get functions
extern void AttitudeRawgyrosSet( float *Newgyros );
extern void AttitudeRawgyrosGet( float *Newgyros );
extern void AttitudeRawaccelsSet( float *Newaccels );
extern void AttitudeRawaccelsGet( float *Newaccels );
extern void AttitudeRawmagnetometersSet( int16_t *Newmagnetometers );
extern void AttitudeRawmagnetometersGet( int16_t *Newmagnetometers );
extern void AttitudeRawgyrotempSet( uint16_t *Newgyrotemp );
extern void AttitudeRawgyrotempGet( uint16_t *Newgyrotemp );
